...
#Creating a column 'age' ans transforming 'trans_date_trans_time' into hour, day and month columns
...
#Creating a new dataframe containing only the columns relevant to our model
